...
import dbdmod.powers.TVirusPower;
import dbdmod.util.CardStats;

public class TVirus extends BaseCard {
    public static final String ID = makeID(TVirus.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, p, new TVirusPower(p, magicNumber)));
    }
}
