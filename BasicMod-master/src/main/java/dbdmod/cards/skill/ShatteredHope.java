...
public class ShatteredHope extends BaseCard {
    public static final String ID = makeID(ShatteredHope.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (m.hasPower(StrengthPower.POWER_ID)) {
            int strAmount = m.getPower(StrengthPower.POWER_ID).amount;
