...
import dbdmod.relics.BaseRelic;
import dbdmod.util.GeneralUtils;
import dbdmod.util.KeywordInfo;
import dbdmod.util.TextureLoader;
...
public class BasicMod implements
    ...
    private static final String defaultLanguage = "zht";
