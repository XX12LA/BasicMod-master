...
import static dbdmod.BasicMod.characterPath;
...
public class MyCharacter extends CustomPlayer {
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass KILLER;
        @SpireEnum(name = "DARK") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "DARK") @SuppressWarnings("unused")
